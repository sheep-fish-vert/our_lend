...
/* random color by load */
    ...
    function randomColors(){
        ...
        $('head').append('<link rel="icon" href="'+pathWp+'/images/favicon_'+color+'.ico" type="image/x-icon"><link rel="icon" type="image/png" sizes="16x16" href="'+pathWp+'/images/favicon_'+color+'_16x16.png"><link rel="icon" type="image/png" sizes="32x32" href="'+pathWp+'/images/favicon_'+color+'_32x32.png"><link rel="icon" type="image/png" sizes="96x96" href="'+pathWp+'/images/favicon_'+color+'_96x96.png">');
